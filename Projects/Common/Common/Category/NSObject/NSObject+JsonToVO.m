...
//  OneStore
//
//  Created by songdong on 13-7-29.
 ...
 *  功能:获取某个属性的类名称,
 *  参数class:源对象
 *  参数propertyString:属性名称
 *  例子 ProductVO中的  rating:  T@"ProductRatingVO",&,N,V_rating
 */
/*- (NSString *)getPropertyType:(id)class property:(NSString *)propertyString
{
    ...
    NSRange r1=[attr safeRangeOfString:@"\""];
    if (r1.location == NSNotFound)
    {
        return nil;
    }
    
    NSRange r2=[[attr safeSubstringFromIndex:r1.location+1] safeRangeOfString:@"\""];
    r1.location=r1.location+1;
    r1.length=r2.location;
    NSString *ret=[attr safeSubstringWithRange:r1];
    return ret;
}*/
