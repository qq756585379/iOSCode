...
@implementation OTSTableView

- (id)dequeueReusableCellWithIdentifier:(NSString *)identifier{
    UITableViewCell *cell = [super dequeueReusableCellWithIdentifier:identifier];
    if ([cell isKindOfClass:[OTSTableViewCell class]]) {
        [(OTSTableViewCell *)cell setIndexPath:nil];
    }
    return cell;
}
...
- (id)dequeueReusableCellWithIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([cell isKindOfClass:[OTSTableViewCell class]]) {
        [(OTSTableViewCell *)cell setIndexPath:indexPath];
    }
    return cell;
}
