...
-(void)initUI{
    ...
    self.collectionView = [[OTSCollectionView alloc]initWithFrame:CGRectZero collectionViewLayout:flowLayout];
    ...
    [self.collectionView registerClass:[BrandCategoryHeader class] forSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:[BrandCategoryHeader cellReuseIdentifier]];
...
- (UICollectionReusableView *)collectionView:(UICollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    NSIndexPath *index=[self.tableView indexPathForSelectedRow];
    BrandCategoryHeader *header=[collectionView dequeueReusableSupplementaryViewOfKind:UICollectionElementKindSectionHeader withReuseIdentifier:[BrandCategoryHeader cellReuseIdentifier] forIndexPath:indexPath];
