...
- (CGFloat)cellHeight{
    if (!_cellHeight) {
        CGRect attrsRect=[self.chatString boundingRectWithSize:CGSizeMake(300, CGFLOAT_MAX)  options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading context:nil];
