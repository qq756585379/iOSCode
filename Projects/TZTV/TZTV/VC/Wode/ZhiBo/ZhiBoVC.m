...
#import "ChatCell.h"
#import "ChatModel.h"
#import <PLMediaStreamingKit/PLCameraStreamingSession.h>

@interface ZhiBoVC ()<PLCameraStreamingSessionDelegate,UITableViewDataSource,UITableViewDelegate>
...
- (void)viewDidLoad {
    ...
    [self.session setBeautifyModeOn:YES];//开启美颜
    [self.session setBeautify:0.5];
    [self.session setWhiten:0.5];
    [self.session setRedden:0.2];
    [self createTimer];
}
