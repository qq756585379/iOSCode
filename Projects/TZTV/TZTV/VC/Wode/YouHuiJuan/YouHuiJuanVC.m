...
- (void)setupChildViewControllers{
    YouHuiJuanSubVC *vc1=[[YouHuiJuanSubVC alloc] initWithStyle:UITableViewStyleGrouped];
    vc1.type=YouHuiJuanTypeXianShang;
    
    YouHuiJuanSubVC *vc2=[[YouHuiJuanSubVC alloc] initWithStyle:UITableViewStyleGrouped];
