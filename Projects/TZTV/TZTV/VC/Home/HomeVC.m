...
-(void)setupNav{
    self.title=@"首页";
    NSString *city=[YJTOOL objectForKey:CurrentCityKey];
    UIButton *btn=[UIButton createButtonWithFrame:CGRectMake(-10, 0, 60, 30) text:city.length?city:@"上海" textColor:HEXRGBCOLOR(0x333333) font:YJFont(14) image:@"drop_down" bgImage:nil superView:nil];
...
-(void)goToSelectCityVC:(UIButton *)sender{
    CityListVC *cityVC=[[CityListVC alloc] initWithStyle:UITableViewStyleGrouped];
