...
@interface GrouponPaymentMethodError : OTSValueObject

@property(nonatomic, retain) NSNumber *errorCode;//当前订单是否支持
@property(nonatomic, retain) NSString *errorInfo;//不支持的原因
